export const BUSINESS = {
  ...
  blurb:      'The KPS Group is your complete back-office solution for growing businesses in the trades and service industries. We handle bookkeeping, payroll, branding, and business consulting so you can focus on what you do best.',
  mission:    'We help small businesses transform their operations from front office to back office with comprehensive solutions designed specifically for the trades and service industries. From clean books to professional branding, we provide the infrastructure you need to grow.',
  philosophy: 'We don\'t just fix what\'s broken — we tell you why it broke, what it\'s costing you, and how to build something better. We start at your books, challenge your ego, and don\'t stop until your business actually runs like a business. Hate us now, love us later.',
  founder:    'Karson Lawrence, Founder & CEO',
  tagline:    'Complete back-office solutions for growing businesses. Professional support you can trust.',
  foundingYear: '2020',
  employees:  '10-50',
  latitude:   30.3916,
  longitude:  -97.7416
